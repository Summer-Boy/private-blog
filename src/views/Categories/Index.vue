<template>
  ...
  >
    ...
    <div :class="isPC ? 'content' : 'wap-content'">
      <div class="cols">
        <div class="cols-item" @click="getDetails(1)">
          <div class="container">
            <div
              class="front"
              :style="{
        ...
        <div class="cols-item" @click="getDetails(2)">
          <div class="container">
            <div
              class="front"
              :style="{
        ...
        <div class="cols-item" @click="getDetails(3)">
          <div class="container">
            <div
              class="front"
              :style="{
        ...
        <div class="cols-item" @click="getDetails(4)">
          <div class="container">
            <div
              class="front"
              :style="{
...
export default {
  ...
  data() {
    return {
      categories: [],
      categoriesBgImg: require("../../assets/category.jpg"),
    };
  },
  methods: {
    getDetails(id) {
